...
def test_search_case_insensitive() -> None:
    ...
    """
    rows = analytics_service.analytics_service.search_reviews_by_title("avengers")
...
def test_sort_by_rating_desc() -> None:
    ...
    """
    rows = analytics_service.analytics_service.search_reviews_by_title(
...
def test_write_reviews_csv(tmp_path) -> None:
    ...
    """
    rows = analytics_service.analytics_service.search_reviews_by_title("joker")
    ...
    csv_path = analytics_service.analytics_service.write_reviews_csv(
