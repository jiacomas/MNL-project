...
from services.movies_service import get_movies, search_movies, get_movie_stats
from schemas.movies import MovieSearchFilters, MovieListResponse
...
class TestMoviesServiceIntegration:
    ...
    def test_integration_get_movies(self, real_repository):
        ...
        with patch('services.movies_service.movie_repo', real_repository):
