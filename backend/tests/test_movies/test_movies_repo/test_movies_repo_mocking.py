...
from repositories.movies_repo import MovieRepository, _dict_to_movie_dict
...
class TestMovieRepositoryMocking:
    ...
    def test_mock_repo_datetime_operations(self):
        ...
        with patch('repositories.movies_repo.datetime') as mock_datetime:
    ...
    def test_mock_repo_uuid_generation(self):
        ...
        with patch('repositories.movies_repo.uuid.uuid4') as mock_uuid:
    ...
    def test_mock_repo_csv_operations(self):
        ...
        with patch('repositories.movies_repo._load_movies_from_csv') as mock_load, \
                patch('repositories.movies_repo._save_movies_to_csv') as mock_save:
            mock_load.return_value = [
                {
    ...
    def test_mock_repo_json_operations(self):
        ...
        with patch('repositories.movies_repo._load_movies_from_json') as mock_load, \
                patch('repositories.movies_repo._save_movies_to_json') as mock_save:
            mock_load.return_value = [
                {
