...
from repositories.movies_repo import MovieRepository
...
class TestMoviesRepoExceptionHandling:
    ...
    def test_movies_repo_duplicate_movie_creation(self):
        ...
        try:
            with patch('repositories.movies_repo.MOVIES_CSV_PATH', temp_path):
    ...
    def test_movies_repo_corrupted_json_file(self):
        ...
        try:
            with patch('repositories.movies_repo.MOVIES_JSON_PATH', temp_path):
    ...
    def test_movies_repo_missing_data_directory(self, tmp_path):
        ...
        with patch('repositories.movies_repo.MOVIES_CSV_PATH', str(non_existent_path)):
            repo = MovieRepository(use_json=False)
    ...
    def test_movies_repo_file_permission_denied(self, tmp_path):
        ...
        try:
            with patch('repositories.movies_repo.MOVIES_CSV_PATH', str(read_only_file)):
                repo = MovieRepository(use_json=False)
