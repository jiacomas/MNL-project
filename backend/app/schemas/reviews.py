...
class ReviewUpdate(BaseModel):
    rating: Optional[int] = Field(None, ge=1, le=10, description="Updated rating score from 1 to 10")
    comment: Optional[str] = Field(None, max_length=2000, description="Updated comment (optional)")
